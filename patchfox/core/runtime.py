...
PatchFox owns session state, workspace context, memory, checkpoints, and persistence.
...
class PatchFox(RuntimeSecretsMixin, RuntimeCheckpointsMixin):
    def __init__(
        ...
        self.shell_backend = shell_backend or resolve_shell_backend()
        ...
        self.run_store = run_store or RunStore(
            Path(workspace.repo_root) / ".patchfox" / "runs"
        )
    ...
    def _resolve_memory_dir(self, memory_dir):
        if memory_dir:
            ...
            path = self.root / ".patchfox" / "memory"
    ...
    def current_runtime_identity(self):
        return {
            ...
            "shell_backend": self.shell_backend.name,
    ...
    def build_prefix(self):
        ...
        text = textwrap.dedent(
            f"""\
            You are patchfox, a small local coding agent working inside a local repository.
            ...
            {self.shell_backend.prompt_hint}
