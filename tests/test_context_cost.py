...
from patchfox.providers.clients import AnthropicCompatibleModelClient
...
def test_deterministic_prompt_experiment_pairs_full_and_no_reduction(tmp_path):
    from patchfox.evaluation.context_cost import run_deterministic_prompt_experiment
...
def test_summarize_paired_rows_rejects_quality_regression():
    from patchfox.evaluation.context_cost import CostUsage, ExperimentRow, summarize_paired_rows
...
def test_markdown_report_includes_net_benefit_section(tmp_path):
    from patchfox.evaluation.context_cost import render_markdown_report, run_deterministic_prompt_experiment
...
def test_scripted_e2e_experiment_records_tool_use(tmp_path):
    from patchfox.evaluation.context_cost import run_scripted_e2e_experiment
