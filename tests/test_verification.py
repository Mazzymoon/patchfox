...
from patchfox.core.verification import reduce_verification_signal
...
def test_verification_classifier_accepts_common_test_commands():
    cases = {
        ...
        "python3.11 -m compileall patchfox": "compile",
        "ruff check patchfox tests": "lint",
        "mypy patchfox": "typecheck",
        "pyright": "typecheck",
        "python -m compileall patchfox": "compile",
        "npm test": "test",
        "npm run test": "test",
        "npm run build": "build",
        "pnpm test": "test",
    ...
    for command, command_class in cases.items():
        ...
        assert signal["schema_version"] == "patchfox.verification_signal.v1"
...
def test_verification_signal_marks_workspace_change_as_missing_until_verified():
    ...
    assert signal == {
        "schema_version": "patchfox.verification_signal.v1",
        "state": "missing",
