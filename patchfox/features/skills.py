...
SKILL_FILE_CREATION_GUIDE = """When creating PatchFox skill files at .patchfox/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${PATCHFOX_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        ...
        (Path(root) / ".patchfox" / "skills", "project"),
    ]
    try:
    ...
    if user_home is not None:
        search_roots.insert(0, (user_home / ".patchfox" / "skills", "user"))
