...
from patchfox.evaluation.memory_agent_eval import run_memory_agent_eval_v1
from patchfox.evaluation.metrics import main as metrics_main, write_benchmark_core_report
...
def test_memory_report_does_not_present_contract_as_benchmark(tmp_path):
    ...
    assert "PatchFox 长期记忆能力达到 100%" not in text
