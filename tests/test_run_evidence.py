...
def test_run_evidence_reads_trace_report_and_session_artifacts(tmp_path):
        ...
        json.dumps(
            {
                ...
                "runtime_reminders": [{"artifact_path": ".patchfox/runs/run_1/artifacts/fallback.txt"}],
                ...
                json.dumps(
                    {
                        "event": "tool_executed",
                        "name": "run_shell",
                        "full_output_artifact": ".patchfox/runs/run_1/artifacts/output.txt",
                    }
                ),
    ...
    assert evidence.full_output_artifacts() == [
        ".patchfox/runs/run_1/artifacts/output.txt",
        ".patchfox/runs/run_1/artifacts/fallback.txt",
    ]
