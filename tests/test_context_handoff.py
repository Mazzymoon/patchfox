from patchfox.core.context_handoff import HandoffAdapter, HandoffParser, HandoffSummary, render_handoff_summary
...
## Files Read
- patchfox/core/compact.py

## Files Modified
- patchfox/core/context_handoff.py
...
def test_parser_valid_output_extracts_sections():
    ...
    assert summary.files_read == ("patchfox/core/compact.py",)
    assert summary.files_modified == ("patchfox/core/context_handoff.py",)
...
def test_render_handoff_summary_preserves_critical_sections():
    ...
    assert "- patchfox/core/compact.py" in text
