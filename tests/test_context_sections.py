from patchfox.core.context_sections import (
...
def test_context_manager_exports_legacy_section_policy_names():
    from patchfox.core.context_manager import (
        DEFAULT_REDUCTION_ORDER,
        DEFAULT_SECTION_FLOORS,
        DEFAULT_TOTAL_BUDGET,
    )
    from patchfox.core.context_sections import SECTION_ORDER as LEGACY_ORDER
