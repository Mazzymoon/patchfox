...
from patchfox.core.compact import CompactPlan
...
"""
    ...
    assert "- patchfox/core/compact.py" in agent.session["history"][0]["content"]
...
def test_deterministic_compact_extracts_mixed_language_evidence(tmp_path):
    ...
    agent.record(
        {
            "role": "tool",
            "name": "read_file",
            "args": {"path": "patchfox/core/compact.py"},
    ...
    assert "patchfox/core/compact.py" in summary
