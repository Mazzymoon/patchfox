...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available PatchFox skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a PatchFox skill."),
    ...
    SlashCommand("exit", "/exit", "Exit PatchFox.", ("quit",)),
)


def command_help_text() -> str:
    # Assistant responses are rendered as Markdown in the TUI. Plain newlines
    # inside a paragraph are collapsed, so use a real list for one command per row.
    lines = ["Commands:", ""]
