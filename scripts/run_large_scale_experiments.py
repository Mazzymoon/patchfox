...
from patchfox.evaluation.metrics import (  # noqa: E402
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Run patchfox large-scale experiments and write all experiment artifacts.")
